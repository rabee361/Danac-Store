...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('base', '0028_alter_codeverivecation_created_at_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='expires_at',
            field=models.DateTimeField(default=datetime.datetime(2023, 12, 24, 15, 30, 8, 623356, tzinfo=datetime.timezone.utc)),
        ),
        migrations.CreateModel(
