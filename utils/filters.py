...
class DebtClientFilter(django_filters.FilterSet):
    ...
    class Meta: 
        model = Debt_Client
        fields = ['client_name','payment_method','receipt_num']
...
class DebtSupplierFilter(django_filters.FilterSet):
    ...
    class Meta: 
        model = Debt_Supplier
        fields = ['supplier_name','payment_method','receipt_num']
...
class ReturnedPackageClientFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = ['date_from','date_to','client_name']
...
class ReturnedPackageSupplierFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = ['date_from','date_to','supplier_name']
